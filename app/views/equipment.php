...
<section class="home-section mb-10">
    <div
        ...
        <div class="d-flex flex-row">
            ...
            <div class="d-flex flex-column ms-12">
                <label for="customerName" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nome do
                    Cliente</label>
    ...
    <div class="d-flex justify-content-between">
        ...
        <button data-modal-target="modal-item" data-modal-toggle="modal-item" onclick="newItem();"
            class="text-white h-20 ml-auto w-30 mr-20 bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-base px-4 py-2 me-2 mb-2">
                ...
                <?php foreach ($items as $item):
                    ...
                    <?php else: ?>
                        ...
                        <td class="flex items-center px-6 py-4 ms-20">
                            <button data-modal-target="modal-item" data-modal-toggle="modal-item"
                                class="text-white w-auto mr-4 bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
                                onclick="editItem(<?= $itemId ?>)">Editar</button>
                            <button id="open-movement-modal" data-modal-target="modal-type" data-modal-toggle="modal-type"
                                class="text-white w-auto bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
                                onclick="getItemId(<?= $itemId ?>)">Adicionar Movimentação</button>
                            <button
                                class="text-white w-auto bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 ms-2 mb-2"
                                onclick="remove(<?= $item->getId(); ?>, '../app/controllers/removeItemController.php', 'este item')">Remover</button>
                        </td>
                    <?php endif; ?>
                    </tr>
                <?php endforeach; ?>
