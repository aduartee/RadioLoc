        ...
        <div class="row">
            <div class="col-md-6">
                <div class="d-flex flex-column mb-3">
                    ...
                    <input type="text" name="itemName" value="<?= $getById && !(empty($getById->getItemName())) ? $getById->getItemName() : '' ?>" placeholder="Ex: Radio" class="form-style w-75">
                </div>

                <div class="d-flex flex-column mb-3">
                    <label for="location" class="form-label label-form fw-bold mb-2">Localização do Equipamento</label>
                    <input type="text" name="location" value="<?= $getById && !(empty($getById->getLocation())) ? $getById->getLocation() : '' ?>" placeholder="Ex: Rua São João" class="form-style w-75">
                </div>

                <div class="d-flex flex-column mb-3">
                    <label for="clientName" class="form-label label-form fw-bold mb-2">Nome do Cliente</label>
                    <input type="text" name="clientName" value="<?= $getById && !(empty($getById->getClientName())) ? $getById->getClientName() : '' ?>" placeholder="Ex: João Ribas" class="form-style w-75">
                </div>

                <div class="d-flex flex-column">
                    <label for="model" class="form-label label-form fw-bold mb-2">Modelo do Equipamento</label>
                    <input type="text" name="model" value="<?= $getById && !(empty($getById->getModel())) ? $getById->getModel() : '' ?>" placeholder="Ex: RC 3002 S2" class="form-style w-75">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="d-flex flex-column mb-3">
                    ...
                    <input type="text" name="serialNumber" value="<?= $getById && !(empty($getById->getSerialNumber())) ? $getById->getSerialNumber() : '' ?>" placeholder="Ex: RX00-xwqe-tiew" class="form-style w-75">
                </div>
                ...
                <div class="d-flex flex-column mb-3">
                    ...
                    <input type="text" name="lastMovement" value="<?= $getById && !(empty($getById->getLastMovement())) ? $getById->getLastMovement() : '' ?>" placeholder="Ex: <?= date('d/m/Y') ?>" class="form-style w-75">
                </div>
